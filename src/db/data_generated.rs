...
pub mod fb {
    ...
    impl<'a> CheckpointVec<'a> {
        ...
        pub fn checkpoints(
            ...
            unsafe {
                ...
                >>(CheckpointVec::VT_CHECKPOINTS, None)
            }
        }
    }
    ...
    impl<'a> Default for CheckpointVecArgs<'a> {
        #[inline]
        fn default() -> Self {
            CheckpointVecArgs { checkpoints: None }
        }
    }
    ...
    impl CheckpointVecT {
        pub fn pack<'b>(
            ...
            CheckpointVec::create(_fbb, &CheckpointVecArgs { checkpoints })
        }
    }
    ...
    impl<'a> AccountDetails<'a> {
        ...
        pub fn unpack(&self) -> AccountDetailsT {
            ...
            let sk = self.sk().map(|x| x.to_string());
            let ivk = self.ivk().map(|x| x.to_string());
            let address = self.address().map(|x| x.to_string());
            AccountDetailsT {
                id,
                name,
        ...
        pub fn id(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(AccountDetails::VT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_NAME, None)
            }
        }
        #[inline]
        pub fn seed(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_SEED, None)
            }
        }
        #[inline]
        pub fn aindex(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(AccountDetails::VT_AINDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn sk(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_SK, None)
            }
        }
        #[inline]
        pub fn ivk(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_IVK, None)
            }
        }
        #[inline]
        pub fn address(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_ADDRESS, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> AccountDetailsBuilder<'a, 'b> {
        ...
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_NAME, name);
        }
        #[inline]
        pub fn add_seed(&mut self, seed: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_SEED, seed);
        }
        #[inline]
        pub fn add_aindex(&mut self, aindex: u32) {
            self.fbb_
                .push_slot::<u32>(AccountDetails::VT_AINDEX, aindex, 0);
        }
        #[inline]
        pub fn add_sk(&mut self, sk: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_SK, sk);
        }
        #[inline]
        pub fn add_ivk(&mut self, ivk: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_IVK, ivk);
        }
        #[inline]
        pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_ADDRESS, address);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> AccountDetailsBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl AccountDetailsT {
        pub fn pack<'b>(
            ...
            let aindex = self.aindex;
            let sk = self.sk.as_ref().map(|x| _fbb.create_string(x));
            let ivk = self.ivk.as_ref().map(|x| _fbb.create_string(x));
            let address = self.address.as_ref().map(|x| _fbb.create_string(x));
    ...
    impl<'a> TransparentDetails<'a> {
        ...
        pub fn unpack(&self) -> TransparentDetailsT {
            ...
            let sk = self.sk().map(|x| x.to_string());
            let address = self.address().map(|x| x.to_string());
            TransparentDetailsT { id, sk, address }
        }
        ...
        pub fn id(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(TransparentDetails::VT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn sk(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(TransparentDetails::VT_SK, None)
            }
        }
        #[inline]
        pub fn address(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(TransparentDetails::VT_ADDRESS, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> TransparentDetailsBuilder<'a, 'b> {
        ...
        pub fn add_sk(&mut self, sk: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(TransparentDetails::VT_SK, sk);
        }
        #[inline]
        pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                TransparentDetails::VT_ADDRESS,
                address,
            );
        }
        #[inline]
    ...
    impl TransparentDetailsT {
        pub fn pack<'b>(
            ...
            let sk = self.sk.as_ref().map(|x| _fbb.create_string(x));
            let address = self.address.as_ref().map(|x| _fbb.create_string(x));
            TransparentDetails::create(_fbb, &TransparentDetailsArgs { id, sk, address })
        }
    }
    ...
    impl<'a> ZcashTransaction<'a> {
        ...
        pub fn id(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(ZcashTransaction::VT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn account(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(ZcashTransaction::VT_ACCOUNT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn txid(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_TXID, None)
            }
        }
        #[inline]
        pub fn height(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(ZcashTransaction::VT_HEIGHT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn timestamp(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(ZcashTransaction::VT_TIMESTAMP, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn value(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ZcashTransaction::VT_VALUE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn address(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_ADDRESS, None)
            }
        }
        #[inline]
        pub fn memo(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_MEMO, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ZcashTransactionBuilder<'a, 'b> {
        ...
        pub fn add_account(&mut self, account: u32) {
            self.fbb_
                .push_slot::<u32>(ZcashTransaction::VT_ACCOUNT, account, 0);
        }
        #[inline]
        pub fn add_txid(&mut self, txid: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ZcashTransaction::VT_TXID, txid);
        }
        #[inline]
        pub fn add_height(&mut self, height: u32) {
            self.fbb_
                .push_slot::<u32>(ZcashTransaction::VT_HEIGHT, height, 0);
        }
        #[inline]
        pub fn add_timestamp(&mut self, timestamp: u32) {
            self.fbb_
                .push_slot::<u32>(ZcashTransaction::VT_TIMESTAMP, timestamp, 0);
        }
        #[inline]
        pub fn add_value(&mut self, value: i64) {
            self.fbb_
                .push_slot::<i64>(ZcashTransaction::VT_VALUE, value, 0);
        }
        #[inline]
        pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                ZcashTransaction::VT_ADDRESS,
                address,
            );
        }
        #[inline]
        pub fn add_memo(&mut self, memo: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ZcashTransaction::VT_MEMO, memo);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> ZcashTransactionBuilder<'a, 'b> {
            let start = _fbb.start_table();
