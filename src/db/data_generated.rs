...
impl<'a> IdList<'a> {
  ...
  pub fn ids(&self) -> Option<flatbuffers::Vector<'a, u32>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(IdList::VT_IDS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IdListBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> IdListBuilder<'a, 'b, A> {
...
impl<'a> Account<'a> {
  ...
  pub fn address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Account::VT_ADDRESS, None)}
  }
  #[inline]
  pub fn saved(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Account::VT_SAVED, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AccountBuilder<'a, 'b, A> {
  ...
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Account::VT_ADDRESS, address);
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AccountVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AccountVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    AccountVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> PoolBalance<'a> {
  ...
  pub fn transparent(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PoolBalance::VT_TRANSPARENT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sapling(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PoolBalance::VT_SAPLING, Some(0)).unwrap()}
  }
  #[inline]
  pub fn orchard(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PoolBalance::VT_ORCHARD, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PoolBalanceBuilder<'a, 'b, A> {
  ...
  pub fn add_transparent(&mut self, transparent: u64) {
    self.fbb_.push_slot::<u64>(PoolBalance::VT_TRANSPARENT, transparent, 0);
  }
  #[inline]
  pub fn add_sapling(&mut self, sapling: u64) {
    self.fbb_.push_slot::<u64>(PoolBalance::VT_SAPLING, sapling, 0);
  }
  #[inline]
  pub fn add_orchard(&mut self, orchard: u64) {
    self.fbb_.push_slot::<u64>(PoolBalance::VT_ORCHARD, orchard, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PoolBalanceBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    PoolBalanceBuilder {
      fbb_: _fbb,
      start_: start,
...
impl PoolBalanceT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let sapling = self.sapling;
    let orchard = self.orchard;
    PoolBalance::create(_fbb, &PoolBalanceArgs{
      transparent,
      sapling,
      orchard,
    })
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ShieldedNoteVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ShieldedNoteVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> ShieldedTx<'a> {
  ...
  pub fn messages(&self) -> Option<MemoVec<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<MemoVec>>(ShieldedTx::VT_MESSAGES, None)}
  }
}
...
impl flatbuffers::Verifiable for ShieldedTx<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<MemoVec>>("messages", Self::VT_MESSAGES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ShieldedTxBuilder<'a, 'b, A> {
  ...
  pub fn add_messages(&mut self, messages: flatbuffers::WIPOffset<MemoVec<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<MemoVec>>(ShieldedTx::VT_MESSAGES, messages);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ShieldedTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    ShieldedTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ShieldedTxVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ShieldedTxVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MessageVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MessageVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    MessageVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Memo<'a> {
  ...
  pub fn address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Memo::VT_ADDRESS, None)}
  }
  #[inline]
  pub fn memo(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Memo::VT_MEMO, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MemoBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Memo::VT_ADDRESS, address);
  }
  #[inline]
  pub fn add_memo(&mut self, memo: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Memo::VT_MEMO, memo);
  }
  #[inline]
...
impl<'a> MemoVec<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.memos { builder.add_memos(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> MemoVecT {
    let memos = self.memos().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    MemoVecT {
      memos,
  ...
  #[inline]
  pub fn memos(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Memo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Memo>>>>(MemoVec::VT_MEMOS, None)}
  }
}
...
impl flatbuffers::Verifiable for MemoVec<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Memo>>>>("memos", Self::VT_MEMOS, false)?
     .finish();
    Ok(())
  }
}
pub struct MemoVecArgs<'a> {
    pub memos: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Memo<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MemoVecBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_memos(&mut self, memos: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Memo<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MemoVec::VT_MEMOS, memos);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MemoVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    MemoVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl MemoVecT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    MemoVec::create(_fbb, &MemoVecArgs{
      memos,
    })
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PrevNextBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PrevNextBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    PrevNextBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SendTemplateBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SendTemplateBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SendTemplateBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SendTemplateVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SendTemplateVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ContactVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ContactVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    ContactVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TxTimeValueBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TxTimeValueBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TxTimeValueBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TxTimeValueVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TxTimeValueVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> QuoteVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> QuoteVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    QuoteVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SpendingVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SpendingVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SpendingVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AddressBalanceBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AddressBalanceBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AddressBalanceVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AddressBalanceVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CheckpointVecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> CheckpointVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RaptorQDropsBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RaptorQDropsBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RaptorQDropsBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RaptorQResultBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RaptorQResultBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ServersBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ServersBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    ServersBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Progress<'a> {
  ...
  pub fn unpack(&self) -> ProgressT {
    ...
    let balances = self.balances().map(|x| {
      Box::new(x.unpack())
    });
    ProgressT {
      height,
  ...
  pub fn balances(&self) -> Option<PoolBalance<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<PoolBalance>>(Progress::VT_BALANCES, None)}
  }
}
...
impl flatbuffers::Verifiable for Progress<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<PoolBalance>>("balances", Self::VT_BALANCES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ProgressBuilder<'a, 'b, A> {
  ...
  pub fn add_balances(&mut self, balances: flatbuffers::WIPOffset<PoolBalance<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<PoolBalance>>(Progress::VT_BALANCES, balances);
  }
  #[inline]
...
impl ProgressT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let trial_decryptions = self.trial_decryptions;
    let downloaded = self.downloaded;
    let balances = self.balances.as_ref().map(|x|{
      x.pack(_fbb)
    });
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> KeyPackBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> KeyPackBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    KeyPackBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RecipientsBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RecipientsBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RecipientsBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RecipientSummaryBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RecipientSummaryBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnsignedTxSummaryBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> UnsignedTxSummaryBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TxOutputBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TxOutputBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TxOutputBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TxReportBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TxReportBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TxReportBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PaymentURIBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PaymentURIBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    PaymentURIBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AccountAddressBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AccountAddressBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> Swap<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.to_image { builder.add_to_image(x); }
    if let Some(x) = args.to_address { builder.add_to_address(x); }
    if let Some(x) = args.to_amount { builder.add_to_amount(x); }
    if let Some(x) = args.to_currency { builder.add_to_currency(x); }
    if let Some(x) = args.from_image { builder.add_from_image(x); }
    if let Some(x) = args.from_address { builder.add_from_address(x); }
    if let Some(x) = args.from_amount { builder.add_from_amount(x); }
    if let Some(x) = args.from_currency { builder.add_from_currency(x); }
    builder.add_timestamp(args.timestamp);
  ...
  pub fn unpack(&self) -> SwapT {
    ...
    let timestamp = self.timestamp();
    let from_currency = self.from_currency().map(|x| {
      x.to_string()
    });
    let from_amount = self.from_amount().map(|x| {
      x.to_string()
    });
    let from_address = self.from_address().map(|x| {
      x.to_string()
    });
    let from_image = self.from_image().map(|x| {
      x.to_string()
    });
    let to_currency = self.to_currency().map(|x| {
      x.to_string()
    });
    let to_amount = self.to_amount().map(|x| {
      x.to_string()
    });
    let to_address = self.to_address().map(|x| {
      x.to_string()
    });
    let to_image = self.to_image().map(|x| {
      x.to_string()
    });
    SwapT {
      provider,
  ...
  pub fn provider(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_PROVIDER, None)}
  }
  #[inline]
  pub fn provider_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_PROVIDER_ID, None)}
  }
  #[inline]
  pub fn timestamp(&self) -> u32 {
    // Safety:
  ...
  pub fn from_currency(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_FROM_CURRENCY, None)}
  }
  #[inline]
  pub fn from_amount(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_FROM_AMOUNT, None)}
  }
  #[inline]
  pub fn from_address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_FROM_ADDRESS, None)}
  }
  #[inline]
  pub fn from_image(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_FROM_IMAGE, None)}
  }
  #[inline]
  pub fn to_currency(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_TO_CURRENCY, None)}
  }
  #[inline]
  pub fn to_amount(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_TO_AMOUNT, None)}
  }
  #[inline]
  pub fn to_address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_TO_ADDRESS, None)}
  }
  #[inline]
  pub fn to_image(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Swap::VT_TO_IMAGE, None)}
  }
}
...
impl flatbuffers::Verifiable for Swap<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u32>("timestamp", Self::VT_TIMESTAMP, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("from_currency", Self::VT_FROM_CURRENCY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("from_amount", Self::VT_FROM_AMOUNT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("from_address", Self::VT_FROM_ADDRESS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("from_image", Self::VT_FROM_IMAGE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("to_currency", Self::VT_TO_CURRENCY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("to_amount", Self::VT_TO_AMOUNT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("to_address", Self::VT_TO_ADDRESS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("to_image", Self::VT_TO_IMAGE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SwapBuilder<'a, 'b, A> {
  ...
  pub fn add_provider(&mut self, provider: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_PROVIDER, provider);
  }
  #[inline]
  pub fn add_provider_id(&mut self, provider_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_PROVIDER_ID, provider_id);
  }
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: u32) {
  ...
  pub fn add_from_currency(&mut self, from_currency: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_FROM_CURRENCY, from_currency);
  }
  #[inline]
  pub fn add_from_amount(&mut self, from_amount: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_FROM_AMOUNT, from_amount);
  }
  #[inline]
  pub fn add_from_address(&mut self, from_address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_FROM_ADDRESS, from_address);
  }
  #[inline]
  pub fn add_from_image(&mut self, from_image: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_FROM_IMAGE, from_image);
  }
  #[inline]
  pub fn add_to_currency(&mut self, to_currency: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_TO_CURRENCY, to_currency);
  }
  #[inline]
  pub fn add_to_amount(&mut self, to_amount: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_TO_AMOUNT, to_amount);
  }
  #[inline]
  pub fn add_to_address(&mut self, to_address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_TO_ADDRESS, to_address);
  }
  #[inline]
  pub fn add_to_image(&mut self, to_image: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Swap::VT_TO_IMAGE, to_image);
  }
  #[inline]
...
impl SwapT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let timestamp = self.timestamp;
    let from_currency = self.from_currency.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let from_amount = self.from_amount.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let from_address = self.from_address.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let from_image = self.from_image.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let to_currency = self.to_currency.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let to_amount = self.to_amount.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let to_address = self.to_address.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let to_image = self.to_image.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    Swap::create(_fbb, &SwapArgs{
      provider,
      provider_id,
      timestamp,
      from_currency,
...
impl<'a> SwapVec<'a> {
  ...
  #[inline]
  pub fn values(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Swap<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Swap>>>>(SwapVec::VT_VALUES, None)}
  }
}
...
impl flatbuffers::Verifiable for SwapVec<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Swap>>>>("values", Self::VT_VALUES, false)?
     .finish();
    Ok(())
  }
}
pub struct SwapVecArgs<'a> {
    pub values: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Swap<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SwapVecBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_values(&mut self, values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Swap<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SwapVec::VT_VALUES, values);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SwapVecBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SwapVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl SwapVecT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    SwapVec::create(_fbb, &SwapVecArgs{
      values,
    })
  }
}
