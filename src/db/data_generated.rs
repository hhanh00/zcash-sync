...
impl<'a> PlainTx<'a> {
  ...
  pub fn tx_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PlainTx::VT_TX_ID, None)}
  }
  #[inline]
  pub fn height(&self) -> u32 {
    // Safety:
  ...
  pub fn timestamp(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(PlainTx::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> i64 {
    // Safety:
  ...
  pub fn address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PlainTx::VT_ADDRESS, None)}
  }
}
...
impl<'a: 'b, 'b> PlainTxBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_tx_id(&mut self, tx_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PlainTx::VT_TX_ID, tx_id);
  }
  #[inline]
  pub fn add_height(&mut self, height: u32) {
  ...
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: u32) {
    self.fbb_.push_slot::<u32>(PlainTx::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
  pub fn add_value(&mut self, value: i64) {
  ...
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PlainTx::VT_ADDRESS, address);
  }
  #[inline]
...
impl PlainTxT {
  pub fn pack<'b>(
    ...
    PlainTx::create(_fbb, &PlainTxArgs{
      id,
      tx_id,
      height,
      timestamp,
...
impl<'a> PlainTxVec<'a> {
  ...
  #[inline]
  pub fn txs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainTx<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainTx>>>>(PlainTxVec::VT_TXS, None)}
  }
}
...
impl flatbuffers::Verifiable for PlainTxVec<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PlainTx>>>>("txs", Self::VT_TXS, false)?
     .finish();
    Ok(())
  }
}
pub struct PlainTxVecArgs<'a> {
    pub txs: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainTx<'a>>>>>,
}
...
impl<'a: 'b, 'b> PlainTxVecBuilder<'a, 'b> {
  #[inline]
  pub fn add_txs(&mut self, txs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PlainTx<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PlainTxVec::VT_TXS, txs);
  }
  #[inline]
...
impl PlainTxVecT {
  pub fn pack<'b>(
    ...
    PlainTxVec::create(_fbb, &PlainTxVecArgs{
      txs,
    })
  }
}
...
impl<'a> PlainNote<'a> {
  ...
  pub fn tx_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PlainNote::VT_TX_ID, None)}
  }
  #[inline]
  pub fn height(&self) -> u32 {
    // Safety:
  ...
  pub fn timestamp(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(PlainNote::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b> PlainNoteBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_tx_id(&mut self, tx_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PlainNote::VT_TX_ID, tx_id);
  }
  #[inline]
  pub fn add_height(&mut self, height: u32) {
  ...
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: u32) {
    self.fbb_.push_slot::<u32>(PlainNote::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
...
impl PlainNoteT {
  pub fn pack<'b>(
    ...
    let vout = self.vout;
    let value = self.value;
    PlainNote::create(_fbb, &PlainNoteArgs{
      id,
      tx_id,
      height,
      timestamp,
...
impl<'a> PlainNoteVec<'a> {
  ...
  #[inline]
  pub fn notes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainNote<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainNote>>>>(PlainNoteVec::VT_NOTES, None)}
  }
}
...
impl flatbuffers::Verifiable for PlainNoteVec<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PlainNote>>>>("notes", Self::VT_NOTES, false)?
     .finish();
    Ok(())
  }
}
pub struct PlainNoteVecArgs<'a> {
    pub notes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlainNote<'a>>>>>,
}
...
impl<'a: 'b, 'b> PlainNoteVecBuilder<'a, 'b> {
  #[inline]
  pub fn add_notes(&mut self, notes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PlainNote<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PlainNoteVec::VT_NOTES, notes);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> PlainNoteVecBuilder<'a, 'b> {
    let start = _fbb.start_table();
    PlainNoteVecBuilder {
      fbb_: _fbb,
      start_: start,
...
impl PlainNoteVecT {
  pub fn pack<'b>(
    ...
    PlainNoteVec::create(_fbb, &PlainNoteVecArgs{
      notes,
    })
  }
}
...
impl<'a> BTCInput<'a> {
  ...
  pub fn tx_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(BTCInput::VT_TX_ID, None)}
  }
  #[inline]
  pub fn vout(&self) -> u32 {
    // Safety:
...
impl<'a: 'b, 'b> BTCInputBuilder<'a, 'b> {
  #[inline]
  pub fn add_tx_id(&mut self, tx_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BTCInput::VT_TX_ID, tx_id);
  }
  #[inline]
  pub fn add_vout(&mut self, vout: u32) {
...
impl BTCInputT {
  pub fn pack<'b>(
    ...
    let vout = self.vout;
    let value = self.value;
    BTCInput::create(_fbb, &BTCInputArgs{
      tx_id,
      vout,
      value,
    })
...
impl<'a> BTCOutput<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_value(args.value);
    if let Some(x) = args.script_pubkey { builder.add_script_pubkey(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> BTCOutputT {
    let script_pubkey = self.script_pubkey().map(|x| {
      x.to_string()
    });
    let value = self.value();
    BTCOutputT {
  ...
  pub fn script_pubkey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(BTCOutput::VT_SCRIPT_PUBKEY, None)}
  }
  #[inline]
  pub fn value(&self) -> u64 {
    // Safety:
...
impl flatbuffers::Verifiable for BTCOutput<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("script_pubkey", Self::VT_SCRIPT_PUBKEY, false)?
     .visit_field::<u64>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b> BTCOutputBuilder<'a, 'b> {
  ...
  pub fn add_script_pubkey(&mut self, script_pubkey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BTCOutput::VT_SCRIPT_PUBKEY, script_pubkey);
  }
  #[inline]
  pub fn add_value(&mut self, value: u64) {
...
impl BTCOutputT {
  pub fn pack<'b>(
    ...
    let script_pubkey = self.script_pubkey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let value = self.value;
    BTCOutput::create(_fbb, &BTCOutputArgs{
      script_pubkey,
      value,
    })
  }
...
impl<'a> BTCTx<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.txouts { builder.add_txouts(x); }
    if let Some(x) = args.txins { builder.add_txins(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> BTCTxT {
    let txins = self.txins().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let txouts = self.txouts().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let fee = self.fee();
    BTCTxT {
  ...
  #[inline]
  pub fn txins(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCInput<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCInput>>>>(BTCTx::VT_TXINS, None)}
  }
  #[inline]
  pub fn txouts(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCOutput<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCOutput>>>>(BTCTx::VT_TXOUTS, None)}
  }
  #[inline]
  pub fn fee(&self) -> u64 {
    // Safety:
...
impl flatbuffers::Verifiable for BTCTx<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BTCInput>>>>("txins", Self::VT_TXINS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BTCOutput>>>>("txouts", Self::VT_TXOUTS, false)?
...
pub struct BTCTxArgs<'a> {
    pub txins: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCInput<'a>>>>>,
    pub txouts: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BTCOutput<'a>>>>>,
    pub fee: u64,
}
...
impl<'a: 'b, 'b> BTCTxBuilder<'a, 'b> {
  #[inline]
  pub fn add_txins(&mut self, txins: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<BTCInput<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BTCTx::VT_TXINS, txins);
  }
  #[inline]
  pub fn add_txouts(&mut self, txouts: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<BTCOutput<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BTCTx::VT_TXOUTS, txouts);
  }
  #[inline]
...
impl<'a> CheckpointVec<'a> {
  pub const VT_CHECKPOINTS: flatbuffers::VOffsetT = 4;
  ...
  pub fn unpack(&self) -> CheckpointVecT {
    let checkpoints = self.checkpoints().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    CheckpointVecT {
      checkpoints,
  ...
  pub fn checkpoints(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Checkpoint<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Checkpoint>>>>(CheckpointVec::VT_CHECKPOINTS, None)}
  }
}
...
impl<'a: 'b, 'b> CheckpointVecBuilder<'a, 'b> {
  ...
  pub fn add_checkpoints(&mut self, checkpoints: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Checkpoint<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CheckpointVec::VT_CHECKPOINTS, checkpoints);
  }
  #[inline]
...
pub struct CheckpointVecT {
  pub checkpoints: Option<Vec<CheckpointT>>,
}
...
impl<'a> ETHTransaction<'a> {
  ...
  pub fn chain_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ETHTransaction::VT_CHAIN_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn to(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ETHTransaction::VT_TO, None)}
  }
  #[inline]
  pub fn value(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ETHTransaction::VT_VALUE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn nonce(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ETHTransaction::VT_NONCE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn gas(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ETHTransaction::VT_GAS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn max_fee_per_gas(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ETHTransaction::VT_MAX_FEE_PER_GAS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn max_priority_fee_per_gas(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ETHTransaction::VT_MAX_PRIORITY_FEE_PER_GAS, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for ETHTransaction<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u64>("max_priority_fee_per_gas", Self::VT_MAX_PRIORITY_FEE_PER_GAS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> ETHTransactionBuilder<'a, 'b> {
  ...
  pub fn add_chain_id(&mut self, chain_id: u64) {
    self.fbb_.push_slot::<u64>(ETHTransaction::VT_CHAIN_ID, chain_id, 0);
  }
  #[inline]
  pub fn add_to(&mut self, to: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ETHTransaction::VT_TO, to);
  }
  #[inline]
  pub fn add_value(&mut self, value: u64) {
    self.fbb_.push_slot::<u64>(ETHTransaction::VT_VALUE, value, 0);
  }
  #[inline]
  pub fn add_nonce(&mut self, nonce: u32) {
    self.fbb_.push_slot::<u32>(ETHTransaction::VT_NONCE, nonce, 0);
  }
  #[inline]
  ...
  pub fn add_max_fee_per_gas(&mut self, max_fee_per_gas: u64) {
    self.fbb_.push_slot::<u64>(ETHTransaction::VT_MAX_FEE_PER_GAS, max_fee_per_gas, 0);
  }
  #[inline]
  pub fn add_max_priority_fee_per_gas(&mut self, max_priority_fee_per_gas: u64) {
    self.fbb_.push_slot::<u64>(ETHTransaction::VT_MAX_PRIORITY_FEE_PER_GAS, max_priority_fee_per_gas, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ETHTransactionBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl ETHTransactionT {
  pub fn pack<'b>(
    ...
    let max_fee_per_gas = self.max_fee_per_gas;
    let max_priority_fee_per_gas = self.max_priority_fee_per_gas;
    ETHTransaction::create(_fbb, &ETHTransactionArgs{
      chain_id,
      to,
      value,
      nonce,
...
impl<'a> PaymentURI<'a> {
  ...
  pub fn address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PaymentURI::VT_ADDRESS, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PaymentURI::VT_AMOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn memo(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PaymentURI::VT_MEMO, None)}
  }
}
...
impl<'a: 'b, 'b> PaymentURIBuilder<'a, 'b> {
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PaymentURI::VT_ADDRESS, address);
  }
  #[inline]
  pub fn add_amount(&mut self, amount: u64) {
  ...
  #[inline]
  pub fn add_memo(&mut self, memo: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PaymentURI::VT_MEMO, memo);
  }
  #[inline]
...
impl PaymentURIT {
  pub fn pack<'b>(
    ...
    PaymentURI::create(_fbb, &PaymentURIArgs{
      address,
      amount,
      memo,
    })
...
impl<'a> TONTransaction<'a> {
  ...
  pub fn to(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TONTransaction::VT_TO, None)}
  }
  #[inline]
  pub fn value(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(TONTransaction::VT_VALUE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn seqno(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(TONTransaction::VT_SEQNO, Some(0)).unwrap()}
  }
  #[inline]
  pub fn state(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TONTransaction::VT_STATE, None)}
  }
}
...
impl<'a: 'b, 'b> TONTransactionBuilder<'a, 'b> {
  #[inline]
  pub fn add_to(&mut self, to: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TONTransaction::VT_TO, to);
  }
  #[inline]
  pub fn add_value(&mut self, value: u64) {
    self.fbb_.push_slot::<u64>(TONTransaction::VT_VALUE, value, 0);
  }
  #[inline]
  pub fn add_seqno(&mut self, seqno: u32) {
    self.fbb_.push_slot::<u32>(TONTransaction::VT_SEQNO, seqno, 0);
  }
  #[inline]
  pub fn add_state(&mut self, state: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TONTransaction::VT_STATE, state);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TONTransactionBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl TONTransactionT {
  pub fn pack<'b>(
    ...
    TONTransaction::create(_fbb, &TONTransactionArgs{
      to,
      value,
      seqno,
      state,
...
impl<'a> ZcashSyncParams<'a> {
  ...
  pub fn anchor_offset(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashSyncParams::VT_ANCHOR_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn max_cost(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashSyncParams::VT_MAX_COST, Some(0)).unwrap()}
  }
  #[inline]
  pub fn port(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ZcashSyncParams::VT_PORT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> ZcashSyncParamsBuilder<'a, 'b> {
  ...
  pub fn add_anchor_offset(&mut self, anchor_offset: u32) {
    self.fbb_.push_slot::<u32>(ZcashSyncParams::VT_ANCHOR_OFFSET, anchor_offset, 0);
  }
  #[inline]
  pub fn add_max_cost(&mut self, max_cost: u32) {
    self.fbb_.push_slot::<u32>(ZcashSyncParams::VT_MAX_COST, max_cost, 0);
  }
  #[inline]
  pub fn add_port(&mut self, port: i64) {
    self.fbb_.push_slot::<i64>(ZcashSyncParams::VT_PORT, port, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ZcashSyncParamsBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl ZcashSyncParamsT {
  pub fn pack<'b>(
    ...
    let max_cost = self.max_cost;
    let port = self.port;
    ZcashSyncParams::create(_fbb, &ZcashSyncParamsArgs{
      anchor_offset,
      max_cost,
      port,
    })
...
impl<'a> flatbuffers::Follow<'a> for AccountDetails<'a> {
  type Inner = AccountDetails<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> AccountDetails<'a> {
  ...
  pub const VT_AINDEX: flatbuffers::VOffsetT = 10;
  pub const VT_SK: flatbuffers::VOffsetT = 12;
  pub const VT_IVK: flatbuffers::VOffsetT = 14;
  pub const VT_ADDRESS: flatbuffers::VOffsetT = 16;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    AccountDetails { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args AccountDetailsArgs<'args>
  ) -> flatbuffers::WIPOffset<AccountDetails<'bldr>> {
    let mut builder = AccountDetailsBuilder::new(_fbb);
    if let Some(x) = args.address { builder.add_address(x); }
    if let Some(x) = args.ivk { builder.add_ivk(x); }
    if let Some(x) = args.sk { builder.add_sk(x); }
  ...
  pub fn unpack(&self) -> AccountDetailsT {
    let id = self.id();
    let name = self.name().map(|x| {
      x.to_string()
    });
  ...
  pub fn id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(AccountDetails::VT_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_NAME, None)}
  }
  #[inline]
  pub fn seed(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_SEED, None)}
  }
  #[inline]
  pub fn aindex(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(AccountDetails::VT_AINDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sk(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_SK, None)}
  }
  #[inline]
  pub fn ivk(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_IVK, None)}
  }
  #[inline]
  pub fn address(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AccountDetails::VT_ADDRESS, None)}
  }
}

impl flatbuffers::Verifiable for AccountDetails<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("sk", Self::VT_SK, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("ivk", Self::VT_IVK, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("address", Self::VT_ADDRESS, false)?
     .finish();
    Ok(())
  }
}
pub struct AccountDetailsArgs<'a> {
    pub id: u32,
    pub name: Option<flatbuffers::WIPOffset<&'a str>>,
    pub seed: Option<flatbuffers::WIPOffset<&'a str>>,
    pub aindex: u32,
    pub sk: Option<flatbuffers::WIPOffset<&'a str>>,
    pub ivk: Option<flatbuffers::WIPOffset<&'a str>>,
    pub address: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for AccountDetailsArgs<'a> {
  #[inline]
  fn default() -> Self {
    AccountDetailsArgs {
      id: 0,
...
pub struct AccountDetailsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> AccountDetailsBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
    self.fbb_.push_slot::<u32>(AccountDetails::VT_ID, id, 0);
  }
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_NAME, name);
  }
  #[inline]
  pub fn add_seed(&mut self, seed: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_SEED, seed);
  }
  #[inline]
  pub fn add_aindex(&mut self, aindex: u32) {
    self.fbb_.push_slot::<u32>(AccountDetails::VT_AINDEX, aindex, 0);
  }
  #[inline]
  pub fn add_sk(&mut self, sk: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_SK, sk);
  }
  #[inline]
  pub fn add_ivk(&mut self, ivk: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_IVK, ivk);
  }
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AccountDetails::VT_ADDRESS, address);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> AccountDetailsBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<AccountDetails<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for AccountDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("AccountDetails");
      ds.field("id", &self.id());
      ds.field("name", &self.name());
      ds.field("seed", &self.seed());
      ds.field("aindex", &self.aindex());
      ds.field("sk", &self.sk());
      ds.field("ivk", &self.ivk());
      ds.field("address", &self.address());
      ds.finish()
  }
}
...
impl Default for AccountDetailsT {
  fn default() -> Self {
    Self {
      id: 0,
      name: None,
...
impl AccountDetailsT {
  pub fn pack<'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b>
  ) -> flatbuffers::WIPOffset<AccountDetails<'b>> {
    let id = self.id;
    let name = self.name.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let ivk = self.ivk.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let address = self.address.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    AccountDetails::create(_fbb, &AccountDetailsArgs{
      id,
      name,
      seed,
      aindex,
...
pub enum TransparentDetailsOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct TransparentDetails<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for TransparentDetails<'a> {
  type Inner = TransparentDetails<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> TransparentDetails<'a> {
  ...
  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    TransparentDetails { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args TransparentDetailsArgs<'args>
  ) -> flatbuffers::WIPOffset<TransparentDetails<'bldr>> {
  ...
  pub fn sk(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TransparentDetails::VT_SK, None)}
  }
  #[inline]
  pub fn address(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(TransparentDetails::VT_ADDRESS, None)}
  }
}

impl flatbuffers::Verifiable for TransparentDetails<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Default for TransparentDetailsArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct TransparentDetailsBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> TransparentDetailsBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
  ...
  #[inline]
  pub fn add_sk(&mut self, sk: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransparentDetails::VT_SK, sk);
  }
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransparentDetails::VT_ADDRESS, address);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TransparentDetailsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    TransparentDetailsBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<TransparentDetails<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for TransparentDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl Default for TransparentDetailsT {
  fn default() -> Self {
    Self {
      id: 0,
      sk: None,
...
pub enum ZcashTransactionOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct ZcashTransaction<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for ZcashTransaction<'a> {
  type Inner = ZcashTransaction<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> ZcashTransaction<'a> {
  ...
  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    ZcashTransaction { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args ZcashTransactionArgs<'args>
  ) -> flatbuffers::WIPOffset<ZcashTransaction<'bldr>> {
    let mut builder = ZcashTransactionBuilder::new(_fbb);
    builder.add_value(args.value);
    if let Some(x) = args.memo { builder.add_memo(x); }
    if let Some(x) = args.address { builder.add_address(x); }
    builder.add_timestamp(args.timestamp);
  ...
  pub fn unpack(&self) -> ZcashTransactionT {
    let id = self.id();
  ...
  pub fn id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashTransaction::VT_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn account(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashTransaction::VT_ACCOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn txid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_TXID, None)}
  }
  #[inline]
  pub fn height(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashTransaction::VT_HEIGHT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn timestamp(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(ZcashTransaction::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ZcashTransaction::VT_VALUE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn address(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_ADDRESS, None)}
  }
  #[inline]
  pub fn memo(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ZcashTransaction::VT_MEMO, None)}
  }
}

impl flatbuffers::Verifiable for ZcashTransaction<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct ZcashTransactionArgs<'a> {
    pub id: u32,
    pub account: u32,
...
impl<'a> Default for ZcashTransactionArgs<'a> {
  #[inline]
  fn default() -> Self {
    ZcashTransactionArgs {
      id: 0,
      account: 0,
      txid: None,
      height: 0,
...
pub struct ZcashTransactionBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ZcashTransactionBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
    self.fbb_.push_slot::<u32>(ZcashTransaction::VT_ID, id, 0);
  }
  #[inline]
  pub fn add_account(&mut self, account: u32) {
    self.fbb_.push_slot::<u32>(ZcashTransaction::VT_ACCOUNT, account, 0);
  }
  #[inline]
  pub fn add_txid(&mut self, txid: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ZcashTransaction::VT_TXID, txid);
  }
  #[inline]
  pub fn add_height(&mut self, height: u32) {
    self.fbb_.push_slot::<u32>(ZcashTransaction::VT_HEIGHT, height, 0);
  }
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: u32) {
    self.fbb_.push_slot::<u32>(ZcashTransaction::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
  pub fn add_value(&mut self, value: i64) {
    self.fbb_.push_slot::<i64>(ZcashTransaction::VT_VALUE, value, 0);
  }
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ZcashTransaction::VT_ADDRESS, address);
  }
  #[inline]
  pub fn add_memo(&mut self, memo: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ZcashTransaction::VT_MEMO, memo);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ZcashTransactionBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ZcashTransaction<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for ZcashTransaction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ZcashTransaction");
      ds.field("id", &self.id());
...
impl Default for ZcashTransactionT {
  fn default() -> Self {
    Self {
      id: 0,
      account: 0,
...
impl ZcashTransactionT {
  pub fn pack<'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b>
  ) -> flatbuffers::WIPOffset<ZcashTransaction<'b>> {
    let id = self.id;
    let account = self.account;
    ...
    ZcashTransaction::create(_fbb, &ZcashTransactionArgs{
      id,
      account,
      txid,
      height,
...
impl<'a> flatbuffers::Follow<'a> for Note<'a> {
  type Inner = Note<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
...
impl<'a> Note<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args NoteArgs
  ) -> flatbuffers::WIPOffset<Note<'bldr>> {
    let mut builder = NoteBuilder::new(_fbb);
    builder.add_value(args.value);
  ...
  pub fn id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(Note::VT_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn account(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(Note::VT_ACCOUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn pos(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(Note::VT_POS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Note::VT_VALUE, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for Note<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     .visit_field::<u32>("id", Self::VT_ID, false)?
     .visit_field::<u32>("account", Self::VT_ACCOUNT, false)?
     .visit_field::<u32>("pos", Self::VT_POS, false)?
     .visit_field::<u64>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
...
pub struct NoteBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> NoteBuilder<'a, 'b> {
  #[inline]
  pub fn add_id(&mut self, id: u32) {
    self.fbb_.push_slot::<u32>(Note::VT_ID, id, 0);
  }
  #[inline]
  pub fn add_account(&mut self, account: u32) {
    self.fbb_.push_slot::<u32>(Note::VT_ACCOUNT, account, 0);
  }
  #[inline]
  pub fn add_pos(&mut self, pos: u32) {
    self.fbb_.push_slot::<u32>(Note::VT_POS, pos, 0);
  }
  #[inline]
  pub fn add_value(&mut self, value: u64) {
    self.fbb_.push_slot::<u64>(Note::VT_VALUE, value, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> NoteBuilder<'a, 'b> {
    let start = _fbb.start_table();
    NoteBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<Note<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for Note<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Note");
      ds.field("id", &self.id());
      ds.field("account", &self.account());
...
impl NoteT {
  pub fn pack<'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b>
  ) -> flatbuffers::WIPOffset<Note<'b>> {
    let id = self.id;
    let account = self.account;
    let pos = self.pos;
    let value = self.value;
    Note::create(_fbb, &NoteArgs{
      id,
      account,
      pos,
      value,
